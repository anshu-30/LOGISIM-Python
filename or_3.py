...
class AppDemo(QWidget):
    ...
    def onchecking1(self,checked):
        if Qt.Checked==checked or self.check2.isChecked() or self.check3.isChecked():
            self.check_o.setChecked(True)
        
        else:
            self.check_o.setChecked(False)   
    def onchecking2(self,checked):
        if Qt.Checked==checked or self.check1.isChecked() or self.check3.isChecked():
            self.check_o.setChecked(True)
        
        else:
            self.check_o.setChecked(False)   
    def onchecking3(self,checked):
        if Qt.Checked==checked or self.check1.isChecked() or self.check2.isChecked():
            self.check_o.setChecked(True)
