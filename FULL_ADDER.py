...
class AppDemo(QWidget):
    def __init__(self):
      ...
      "QWidget"
        ...
        mainLayout.addWidget(self.check_o,349,700)
        mainLayout.addWidget(self.check_o2,351,700)
    ...
    def onchecking1(self,checked):
        ...
        if(Qt.Checked==checked and self.check2.isChecked()) or (Qt.Checked==checked and self.check3.isChecked()) or (self.check3.isChecked and self.check2.isChecked()):
    ...
    def onchecking2(self,checked):
        ...
        if(Qt.Checked==checked and self.check1.isChecked()) or (Qt.Checked==checked and self.check3.isChecked()) or (self.check3.isChecked and self.check1.isChecked()):
            self.check_o2.setChecked(True)
        else:
            self.check_o2.setChecked(False)               
    def onchecking3(self,checked):
        if (Qt.Checked==checked and not self.check2.isChecked() and not self.check1.isChecked()) or ( not Qt.Checked==checked and self.check2.isChecked() and not self.check1.isChecked()) or (not Qt.Checked==checked and not self.check2.isChecked() and self.check1.isChecked()) or (Qt.Checked==checked and self.check2.isChecked() and self.check1.isChecked()):
            ...
            self.check_o.setChecked(False) 
        if(Qt.Checked==checked and self.check2.isChecked()) or (Qt.Checked==checked and self.check1.isChecked()) or (self.check1.isChecked and self.check2.isChecked()):
            self.check_o2.setChecked(True)
        else:
            self.check_o2.setChecked(False)                                            
