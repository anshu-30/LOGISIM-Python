...
class AppDemo(QWidget):
    ...
    def onchecking1(self,checked):
        if Qt.Checked==checked and not self.check2.isChecked():
            self.check_o.setChecked(True)
        elif not Qt.Checked==checked and self.check2.isChecked():
            self.check_o.setChecked(True)
        
        else:
            self.check_o.setChecked(False)    
    def onchecking2(self,checked):
        if Qt.Checked==checked and not self.check1.isChecked():
            self.check_o.setChecked(True)
        elif not Qt.Checked==checked and self.check1.isChecked():
            self.check_o.setChecked(True)
